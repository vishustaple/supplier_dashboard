...
class Order extends Model
{
    ...
    public static function getFilterdData($filter = [], $csv=false){
        ...
        if (in_array(4, $filter['supplier'])) {
            ...
            if ($filter['core'] == 1) {
                $query->orWhereNotIn('transaction_source_system_desc', ['Staples Promotional Products USA', 'Staples Technology Solutions', 'Sunrise']);
                $query->orWhereNotIn('primary_product_hierarchy_desc', ['STS Technology', 'Promo']);
