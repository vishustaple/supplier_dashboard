        ...
        <div id="layoutSidenav_content">
            <div class="container">
                <div class="m-1 mb-2 d-md-flex border-bottom pb-3 mb-3 align-items-center justify-content-between">
                    ...
                    <i class="fa-solid fa-plus"></i> Create Saved Query</a>
                ...
                <form method="POST" action="{{ route('queries.store') }}">
                    ...
                    <div class="form-floating mb-2">
                        <input class="form-control" placeholder="Write a Title here" id="floatingTitle" name="title" />
                        <label for="floatingTitle">Title</label>
                    </div>
                    <div class="form-floating mb-2">
                        <textarea class="form-control" placeholder="Write a query here" id="floatingTextarea" name="query"></textarea>
                        <label for="floatingTextarea">Query</label>
                    </div>
                    <button class="btn btn-primary float-right" type="submit">Save Query</button>
                </form>
            </div>
        </div>
    </div>
